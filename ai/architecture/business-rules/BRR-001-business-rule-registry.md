...
| BR-0010 | Pricing | High | Repair Cost Master | Repair costs are fixed ₹ deduction amounts per option (OK/Partial/Full), never percentage-based. Scoped per Year+Variant pricing version, not global (amended `AI-0011`/IMP-003 - real data varies per vehicle) | ADR-018, DBD-001 §9 (amended `AI-0011`) | Repair Cost Master, Valuation Engine | Approved |
